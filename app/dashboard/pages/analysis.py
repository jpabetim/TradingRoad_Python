...
def register_callbacks(app):
    ...
    def update_analysis_charts_callback(n_clicks, asset, period):
        return update_analysis_charts(n_clicks, asset, period)
    ...
    def generate_ai_analysis_callback(n_clicks, asset, period):
        return generate_ai_analysis(n_clicks, asset, period)
